...
export const CvCanvas = ({ pdfUrl }: CvCanvasProps) => (
  <div className="flex-1 overflow-y-auto flex justify-center p-6 lg:p-10 relative bg-slate-50 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] bg-fixed z-0">
